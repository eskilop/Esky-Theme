...
strong {
  color: <?php echo Color::toHexString(Color::lighten(Color::get($colors["white"]), 0.05)) ?>;
  font-weight: 700; }
...
a.has-text-dark:hover, a.has-text-dark:focus {
  color: <?php echo Color::toHexString(Color::lighten(Color::get($colors["link"]), 0.05)) ?> !important; }
...
.has-text-info {
  color: <?php echo $colors["cyan"] ?> !important; }

a.has-text-info:hover, a.has-text-info:focus {
  color: <?php echo Color::toHexString(Color::lighten(Color::get($colors["edark"]), 0.1)) ?> !important; }

.has-background-info {
  background-color: <?php echo $colors["cyan"] ?> !important; }

.has-text-success {
  color: <?php echo $colors["green"] ?> !important; }

a.has-text-success:hover, a.has-text-success:focus {
  color: #a2a2a2 !important; }

.has-background-success {
  background-color: <?php echo $colors["green"] ?> !important; }

.has-text-warning {
  color: <?php echo $colors["yellow"] ?> !important; }

a.has-text-warning:hover, a.has-text-warning:focus {
  color: <?php echo Color::toHexString(Color::lighten(Color::get($colors["edark"]), 0.5)) ?> !important; }

.has-background-warning {
  background-color: <?php echo $colors["yellow"] ?> !important; }

.has-text-danger {
  color: <?php echo $colors["red"] ?> !important; }

a.has-text-danger:hover, a.has-text-danger:focus {
  color: #919191 !important; }

.has-background-danger {
  background-color: <?php echo $colors["red"] ?> !important; }

.has-text-lightblue {
  color: <?php echo $colors["lightblue"] ?> !important; }

a.has-text-lightblue:hover, a.has-text-lightblue:focus {
  color: gray !important; }

.has-background-lightblue {
  background-color: <?php echo $colors["lightblue"] ?> !important; }

.has-text-purple {
  color: <?php echo $colors["purple"] ?> !important; }

a.has-text-purple:hover, a.has-text-purple:focus {
  color: #e6e6e6 !important; }

.has-background-purple {
  background-color: <?php echo $colors["purple"] ?> !important; }

.has-text-pink {
  color: <?php echo $colors["pink"] ?> !important; }

a.has-text-pink:hover, a.has-text-pink:focus {
  color: #5e5e5e !important; }

.has-background-pink {
  background-color: <?php echo $colors["pink"] ?> !important; }

.has-text-blue {
  color: <?php echo $colors["blue"] ?> !important; }

a.has-text-blue:hover, a.has-text-blue:focus {
  color: #c4c4c4 !important; }

.has-background-blue {
  background-color: <?php echo $colors["blue"] ?> !important; }

.has-text-orange {
  color: <?php echo $colors["orange"] ?> !important; }

a.has-text-orange:hover, a.has-text-orange:focus {
  color: #b3b3b3 !important; }

.has-background-orange {
  background-color: <?php echo $colors["orange"] ?> !important; }
...
.has-text-grey-light {
  color: <?php echo Color::toHexString(Color::lighten(Color::get($colors["green"]), 0.05)) ?> !important; }

.has-background-grey-light {
  background-color: <?php echo Color::toHexString(Color::lighten(Color::get($colors["green"]), 0.05)) ?> !important; }
...
.box {
  background-color: <?php echo Color::toHexString(Color::lighten(Color::get($colors["edark"]), 0.1)) ?>;
  border-radius: 6px;
...
a.box:hover, a.box:focus {
  box-shadow: 0 0.5em 1em -0.125em rgba(10, 10, 10, 0.1), 0 0 0 1px <?php echo $colors["white"] ?>; }
a.box:active {
  box-shadow: inset 0 1px 2px rgba(10, 10, 10, 0.2), 0 0 0 1px <?php echo $colors["white"] ?>; }

.button {
  background-color: <?php echo Color::toHexString(Color::lighten(Color::get($colors["edark"]), 0.1)) ?>;
  border-color: <?php echo Color::toHexString(Color::lighten(Color::get($colors["edark"]), 0.1)) ?>;
  border-width: 1px;
  color: <?php echo $colors["white"] ?>;
  cursor: pointer;
  ...
  .button.is-white {
    ...
    .button.is-white:hover, .button.is-white.is-hovered {
      background-color: <?php echo Color::toHexString(Color::lighten(Color::get($colors["white"]), 0.05)) ?>;
      border-color: transparent;
      color: #0a0a0a; }
    ...
    .button.is-white.is-outlined {
      ...
      .button.is-white.is-outlined.is-loading::after {
        border-color: transparent transparent <?php echo $colors["white"] ?> <?php echo $colors["white"] ?> !important; }
  ...
  .button.is-primary {
    ...
    .button.is-primary:hover, .button.is-primary.is-hovered {
      background-color: <?php echo Color::toHexString(Color::lighten(Color::get($colors["primary"]), 0.05)) ?>;
      border-color: transparent;
      color: #fff; }
    ...
    .button.is-primary.is-outlined {
      ...
      .button.is-primary.is-outlined.is-loading::after {
        border-color: transparent transparent <?php echo $colors["primary"] ?> <?php echo $colors["primary"] ?> !important; }
  ...
  .button.is-link {
    ...
    .button.is-link:hover, .button.is-link.is-hovered {
      background-color: <?php echo Color::toHexString(Color::lighten(Color::get($colors["link"]), 0.05)) ?>;
      border-color: transparent;
      color: #fff; }
  ...
  .button.is-info {
    ...
    .button.is-info:hover, .button.is-info.is-hovered {
      background-color: <?php echo Color::toHexString(Color::lighten(Color::get($colors["cyan"]), 0.05)) ?>;
      border-color: transparent;
      color: #fff; }
    ...
    .button.is-info:active, .button.is-info.is-active {
      background-color: <?php echo Color::toHexString(Color::lighten(Color::get($colors["edark"]), 0.15)) ?>;
      border-color: transparent;
      color: #fff; }
    ...
    .button.is-info.is-outlined {
      ...
      .button.is-info.is-outlined.is-loading::after {
        border-color: transparent transparent <?php echo $colors["cyan"] ?> <?php echo $colors["cyan"] ?> !important; }
  ...
  .button.is-success {
    ...
    .button.is-success:hover, .button.is-success.is-hovered {
      background-color: <?php echo Color::toHexString(Color::lighten(Color::get($colors["green"]), 0.05)) ?>;
      border-color: transparent;
      color: rgba(0, 0, 0, 0.7); }
    .button.is-success:focus, .button.is-success.is-focused {
      ...
      .button.is-success:focus:not(:active), .button.is-success.is-focused:not(:active) {
        box-shadow: 0 0 0 0.125em rgba(187, 187, 187, 0.25); }
    ...
    .button.is-success.is-outlined {
      ...
      .button.is-success.is-outlined.is-loading::after {
        border-color: transparent transparent <?php echo $colors["green"] ?> <?php echo $colors["green"] ?> !important; }
  ...
  .button.is-warning {
    ...
    .button.is-warning.is-outlined {
      ...
      .button.is-warning.is-outlined.is-loading::after {
        border-color: transparent transparent <?php echo $colors["yellow"] ?> <?php echo $colors["yellow"] ?> !important; }
  ...
  .button.is-danger {
    ...
    .button.is-danger:hover, .button.is-danger.is-hovered {
      background-color: <?php echo Color::toHexString(Color::lighten(Color::get($colors["red"]), 0.05)) ?>;
      border-color: transparent;
      color: #fff; }
    ...
    .button.is-danger.is-outlined {
      ...
      .button.is-danger.is-outlined.is-loading::after {
        border-color: transparent transparent <?php echo $colors["red"] ?> <?php echo $colors["red"] ?> !important; }
  ...
  .button.is-lightblue {
    ...
    .button.is-lightblue:hover, .button.is-lightblue.is-hovered {
      background-color: <?php echo Color::toHexString(Color::lighten(Color::get($colors["lightblue"]), 0.05)) ?>;
      border-color: transparent;
      color: #fff; }
    ...
    .button.is-lightblue.is-outlined {
      ...
      .button.is-lightblue.is-outlined.is-loading::after {
        border-color: transparent transparent <?php echo $colors["lightblue"] ?> <?php echo $colors["lightblue"] ?> !important; }
    ...
    .button.is-lightblue.is-light {
      ...
      .button.is-lightblue.is-light:hover, .button.is-lightblue.is-light.is-hovered {
        ...
        border-color: transparent;
        color: #5e5e5e; }
      .button.is-lightblue.is-light:active, .button.is-lightblue.is-light.is-active {
        background-color: <?php echo Color::toHexString(Color::lighten(Color::get($colors["yellow"]), 0.05)) ?>;
        border-color: transparent;
        color: #5e5e5e; }
  .button.is-purple {
    ...
    .button.is-purple:hover, .button.is-purple.is-hovered {
      background-color: <?php echo Color::toHexString(Color::lighten(Color::get($colors["purple"]), 0.05)) ?>;
      border-color: transparent;
      color: rgba(0, 0, 0, 0.7); }
    ...
    .button.is-purple.is-outlined {
      ...
      .button.is-purple.is-outlined.is-loading::after {
        border-color: transparent transparent <?php echo $colors["purple"] ?> <?php echo $colors["purple"] ?> !important; }
  ...
  .button.is-pink {
    ...
    .button.is-pink:hover, .button.is-pink.is-hovered {
      background-color: <?php echo Color::toHexString(Color::lighten(Color::get($colors["pink"]), 0.05)) ?>;
      border-color: transparent;
      color: #fff; }
    ...
    .button.is-pink.is-outlined {
      ...
      .button.is-pink.is-outlined.is-loading::after {
        border-color: transparent transparent <?php echo $colors["pink"] ?> <?php echo $colors["pink"] ?> !important; }
    ...
    .button.is-pink.is-light {
      ...
      .button.is-pink.is-light:hover, .button.is-pink.is-light.is-hovered {
        ...
        border-color: transparent;
        color: #707070; }
      .button.is-pink.is-light:active, .button.is-pink.is-light.is-active {
        background-color: <?php echo Color::toHexString(Color::lighten(Color::get($colors["yellow"]), 0.05)) ?>;
        border-color: transparent;
        color: #707070; }
  .button.is-blue {
    ...
    .button.is-blue:hover, .button.is-blue.is-hovered {
      background-color: <?php echo Color::toHexString(Color::lighten(Color::get($colors["blue"]), 0.05)) ?>;
      border-color: transparent;
      color: rgba(0, 0, 0, 0.7); }
    ...
    .button.is-blue.is-outlined {
      ...
      .button.is-blue.is-outlined.is-loading::after {
        border-color: transparent transparent <?php echo $colors["blue"] ?> <?php echo $colors["blue"] ?> !important; }
  ...
  .button.is-orange {
    ...
    .button.is-orange:hover, .button.is-orange.is-hovered {
      background-color: <?php echo Color::toHexString(Color::lighten(Color::get($colors["orange"]), 0.05)) ?>;
      border-color: transparent;
      color: rgba(0, 0, 0, 0.7); }
    ...
    .button.is-orange.is-outlined {
      ...
      .button.is-orange.is-outlined.is-loading::after {
        border-color: transparent transparent <?php echo $colors["orange"] ?> <?php echo $colors["orange"] ?> !important; }
...
.progress {
  ...
  .progress.is-white:indeterminate {
    background-image: linear-gradient(to right, <?php echo $colors["white"] ?> 30%, <?php echo Color::toHexString(Color::lighten(Color::get($colors["edark"]), 0.1)) ?> 30%); }
  ...
  .progress.is-dark:indeterminate {
    background-image: linear-gradient(to right, #363636 30%, <?php echo Color::toHexString(Color::lighten(Color::get($colors["edark"]), 0.1)) ?> 30%); }
  ...
  .progress.is-primary:indeterminate {
    background-image: linear-gradient(to right, <?php echo $colors["primary"] ?> 30%, <?php echo Color::toHexString(Color::lighten(Color::get($colors["edark"]), 0.1)) ?> 30%); }
  ...
  .progress.is-info:indeterminate {
    background-image: linear-gradient(to right, <?php echo $colors["cyan"] ?> 30%, <?php echo Color::toHexString(Color::lighten(Color::get($colors["edark"]), 0.1)) ?> 30%); }
  ...
  .progress.is-success:indeterminate {
    background-image: linear-gradient(to right, <?php echo $colors["green"] ?> 30%, <?php echo Color::toHexString(Color::lighten(Color::get($colors["edark"]), 0.1)) ?> 30%); }
  ...
  .progress.is-warning:indeterminate {
    background-image: linear-gradient(to right, <?php echo $colors["yellow"] ?> 30%, <?php echo Color::toHexString(Color::lighten(Color::get($colors["edark"]), 0.1)) ?> 30%); }
  ...
  .progress.is-danger:indeterminate {
    background-image: linear-gradient(to right, <?php echo $colors["red"] ?> 30%, <?php echo Color::toHexString(Color::lighten(Color::get($colors["edark"]), 0.1)) ?> 30%); }
  ...
  .progress.is-lightblue:indeterminate {
    background-image: linear-gradient(to right, <?php echo $colors["lightblue"] ?> 30%, <?php echo Color::toHexString(Color::lighten(Color::get($colors["edark"]), 0.1)) ?> 30%); }
  ...
  .progress.is-purple:indeterminate {
    background-image: linear-gradient(to right, <?php echo $colors["purple"] ?> 30%, <?php echo Color::toHexString(Color::lighten(Color::get($colors["edark"]), 0.1)) ?> 30%); }
  ...
  .progress.is-pink:indeterminate {
    background-image: linear-gradient(to right, <?php echo $colors["pink"] ?> 30%, <?php echo Color::toHexString(Color::lighten(Color::get($colors["edark"]), 0.1)) ?> 30%); }
  ...
  .progress.is-blue:indeterminate {
    background-image: linear-gradient(to right, <?php echo $colors["blue"] ?> 30%, <?php echo Color::toHexString(Color::lighten(Color::get($colors["edark"]), 0.1)) ?> 30%); }
  ...
  .progress.is-orange:indeterminate {
    background-image: linear-gradient(to right, <?php echo $colors["orange"] ?> 30%, <?php echo Color::toHexString(Color::lighten(Color::get($colors["edark"]), 0.1)) ?> 30%); }
...
.input, .textarea, .select select {
  background-color: <?php echo Color::toHexString(Color::lighten(Color::get($colors["edark"]), 0.1)) ?>;
  border-color: <?php echo Color::toHexString(Color::lighten(Color::get($colors["edark"]), 0.05)) ?>;
  border-radius: 0.5rem;
  color: <?php echo $colors["white"] ?>; }
  .input::-moz-placeholder, .textarea::-moz-placeholder, .select select::-moz-placeholder {
    color: rgba(170, 0, 0, 0.3); }
...
.input, .textarea {
  ...
  .is-danger.input, .is-danger.textarea {
    ...
    .is-danger.input:focus, .is-danger.textarea:focus, .is-danger.is-focused.input, .is-danger.is-focused.textarea, .is-danger.input:active, .is-danger.textarea:active, .is-danger.is-active.input, .is-danger.is-active.textarea {
      box-shadow: 0 0 0 0.125em rgba(170, 170, 170, 0.25); }
  .is-lightblue.input, .is-lightblue.textarea {
    border-color: <?php echo $colors["lightblue"] ?>; }
    .is-lightblue.input:focus, .is-lightblue.textarea:focus, .is-lightblue.is-focused.input, .is-lightblue.is-focused.textarea, .is-lightblue.input:active, .is-lightblue.textarea:active, .is-lightblue.is-active.input, .is-lightblue.is-active.textarea {
      box-shadow: 0 0 0 0.125em rgba(153, 153, 153, 0.25); }
  .is-purple.input, .is-purple.textarea {
    border-color: <?php echo $colors["purple"] ?>; }
    .is-purple.input:focus, .is-purple.textarea:focus, .is-purple.is-focused.input, .is-purple.is-focused.textarea, .is-purple.input:active, .is-purple.textarea:active, .is-purple.is-active.input, .is-purple.is-active.textarea {
      box-shadow: 0 0 0 0.125em rgba(255, 255, 255, 0.25); }
  .is-pink.input, .is-pink.textarea {
    border-color: <?php echo $colors["pink"] ?>; }
    .is-pink.input:focus, .is-pink.textarea:focus, .is-pink.is-focused.input, .is-pink.is-focused.textarea, .is-pink.input:active, .is-pink.textarea:active, .is-pink.is-active.input, .is-pink.is-active.textarea {
      box-shadow: 0 0 0 0.125em rgba(119, 119, 119, 0.25); }
  .is-blue.input, .is-blue.textarea {
    border-color: <?php echo $colors["blue"] ?>; }
    .is-blue.input:focus, .is-blue.textarea:focus, .is-blue.is-focused.input, .is-blue.is-focused.textarea, .is-blue.input:active, .is-blue.textarea:active, .is-blue.is-active.input, .is-blue.is-active.textarea {
      box-shadow: 0 0 0 0.125em rgba(221, 221, 221, 0.25); }
  ...
  .is-red.input, .is-red.textarea {
    border-color: <?php echo $colors["red"] ?>; }
    .is-red.input:focus, .is-red.textarea:focus, .is-red.is-focused.input, .is-red.is-focused.textarea, .is-red.input:active, .is-red.textarea:active, .is-red.is-active.input, .is-red.is-active.textarea {
      box-shadow: 0 0 0 0.125em rgba(170, 170, 170, 0.25); }
  .is-green.input, .is-green.textarea {
    border-color: <?php echo $colors["green"] ?>; }
    .is-green.input:focus, .is-green.textarea:focus, .is-green.is-focused.input, .is-green.is-focused.textarea, .is-green.input:active, .is-green.textarea:active, .is-green.is-active.input, .is-green.is-active.textarea {
      box-shadow: 0 0 0 0.125em rgba(187, 187, 187, 0.25); }
  .is-yellow.input, .is-yellow.textarea {
    ...
    .is-yellow.input:focus, .is-yellow.textarea:focus, .is-yellow.is-focused.input, .is-yellow.is-focused.textarea, .is-yellow.input:active, .is-yellow.textarea:active, .is-yellow.is-active.input, .is-yellow.is-active.textarea {
      box-shadow: 0 0 0 0.125em rgba(238, 238, 238, 0.25); }
  .is-cyan.input, .is-cyan.textarea {
    border-color: <?php echo $colors["cyan"] ?>; }
    .is-cyan.input:focus, .is-cyan.textarea:focus, .is-cyan.is-focused.input, .is-cyan.is-focused.textarea, .is-cyan.input:active, .is-cyan.textarea:active, .is-cyan.is-active.input, .is-cyan.is-active.textarea {
      box-shadow: 0 0 0 0.125em rgba(136, 136, 136, 0.25); }
...
.select {
  ...
  .select.is-info select {
    ...
    .select.is-info select:hover, .select.is-info select.is-hovered {
      border-color: <?php echo Color::toHexString(Color::lighten(Color::get($colors["edark"]), 0.15)) ?>; }
...
.file {
  ...
  .file.is-info:focus .file-cta, .file.is-info.is-focused .file-cta {
    border-color: transparent;
    box-shadow: 0 0 0.5em rgba(136, 136, 136, 0.25);
    color: #fff; }
  ...
  .file.is-success:focus .file-cta, .file.is-success.is-focused .file-cta {
    border-color: transparent;
    box-shadow: 0 0 0.5em rgba(187, 187, 187, 0.25);
    color: rgba(0, 0, 0, 0.7); }
...
.file-label {
  ...
  .file-label:hover .file-cta {
    ...
    color: <?php echo Color::toHexString(Color::lighten(Color::get($colors["edark"]), 0.5)) ?>; }
  .file-label:hover .file-name {
    border-color: <?php echo Color::toHexString(Color::lighten(Color::get($colors["edark"]), 0.5)) ?>; }
...
.breadcrumb {
  ...
  .breadcrumb li {
    ...
    .breadcrumb li + li::before {
      color: <?php echo Color::toHexString(Color::lighten(Color::get($colors["green"]), 0.05)) ?>;
      content: "/"; }
  .breadcrumb ul,
  .breadcrumb ol {
...
.card-footer {
  background-color: transparent;
  border-top: 1px solid <?php echo Color::toHexString(Color::lighten(Color::get($colors["edark"]), 0.12)) ?>;
  align-items: stretch;
  display: flex; }
...
.card-footer-item {
  ...
  .card-footer-item:not(:last-child) {
    border-right: 1px solid <?php echo Color::toHexString(Color::lighten(Color::get($colors["edark"]), 0.12)) ?>; }
...
.navbar-item {
  ...
  .navbar-item.is-tab {
    ...
    .navbar-item.is-tab:focus, .navbar-item.is-tab:hover {
      background-color: transparent;
      border-bottom-color: <?php echo $colors["white"] ?>; }
...
@media screen and (min-width: 1024px) {
  ...
  .navbar-item {
    ...
    .navbar-item.has-dropdown-up .navbar-dropdown {
      border-bottom: 2px solid <?php echo Color::toHexString(Color::lighten(Color::get($colors["edark"]), 0.12)) ?>;
  ...
  .navbar-dropdown {
    ...
    border-bottom-left-radius: 6px;
    border-bottom-right-radius: 6px;
    border-top: 2px solid <?php echo Color::toHexString(Color::lighten(Color::get($colors["edark"]), 0.12)) ?>;
    box-shadow: 0 8px 8px rgba(10, 10, 10, 0.1);
    display: none;
    font-size: 0.875rem;
    left: 0;
...
.panel {
  ...
  .panel.is-primary .panel-tabs a.is-active {
    border-bottom-color: <?php echo $colors["primary"] ?>; }
  ...
  .panel.is-info .panel-tabs a.is-active {
    border-bottom-color: <?php echo $colors["cyan"] ?>; }
  ...
  .panel.is-success .panel-tabs a.is-active {
    border-bottom-color: <?php echo $colors["green"] ?>; }
  ...
  .panel.is-warning .panel-tabs a.is-active {
    border-bottom-color: <?php echo $colors["yellow"] ?>; }
  ...
  .panel.is-danger .panel-tabs a.is-active {
    border-bottom-color: <?php echo $colors["red"] ?>; }
  .panel.is-danger .panel-block.is-active .panel-icon {
    color: <?php echo $colors["red"] ?>; }
  .panel.is-lightblue .panel-heading {
    background-color: <?php echo $colors["lightblue"] ?>;
    color: #fff; }
  .panel.is-lightblue .panel-tabs a.is-active {
    border-bottom-color: <?php echo $colors["lightblue"] ?>; }
  .panel.is-lightblue .panel-block.is-active .panel-icon {
    color: <?php echo $colors["lightblue"] ?>; }
  .panel.is-purple .panel-heading {
    background-color: <?php echo $colors["purple"] ?>;
    color: rgba(0, 0, 0, 0.7); }
  .panel.is-purple .panel-tabs a.is-active {
    border-bottom-color: <?php echo $colors["purple"] ?>; }
  ...
  .panel.is-pink .panel-tabs a.is-active {
    border-bottom-color: <?php echo $colors["pink"] ?>; }
  ...
  .panel.is-blue .panel-tabs a.is-active {
    border-bottom-color: <?php echo $colors["blue"] ?>; }
  ...
  .panel.is-orange .panel-tabs a.is-active {
    border-bottom-color: <?php echo $colors["orange"] ?>; }
...
.panel-block {
  ...
  .panel-block.is-active {
    border-left-color: <?php echo $colors["white"] ?>;
    color: #363636; }
...
.tabs {
  ...
  .tabs a {
    ...
    vertical-align: top; }
    .tabs a:hover {
      border-bottom-color: <?php echo Color::toHexString(Color::lighten(Color::get($colors["white"]), 0.05)) ?>;
      color: <?php echo Color::toHexString(Color::lighten(Color::get($colors["white"]), 0.05)) ?>; }
  .tabs li {
    display: block; }
    .tabs li.is-active a {
...
.hero {
  ...
  .hero.is-white {
    ...
    .hero.is-white.is-bold {
      background-image: linear-gradient(141deg, #770014 0%, <?php echo $colors["white"] ?> 71%, #c42100 100%); }
      @media screen and (max-width: 768px) {
  ...
  .hero.is-primary {
    ...
    .hero.is-primary.is-bold {
      background-image: linear-gradient(141deg, #2f2628 0%, <?php echo $colors["primary"] ?> 71%, #554e4d 100%); }
      @media screen and (max-width: 768px) {
  ...
  .hero.is-link {
    ...
    .hero.is-link.is-bold {
      background-image: linear-gradient(141deg, #090808 0%, <?php echo $colors["white"] ?> 71%, #312d2c 100%); }
      @media screen and (max-width: 768px) {
  ...
  .hero.is-info {
    ...
    .hero.is-info.is-bold {
      background-image: linear-gradient(141deg, #7a6367 0%, <?php echo $colors["cyan"] ?> 71%, #9a918f 100%); }
      @media screen and (max-width: 768px) {
  ...
  .hero.is-success {
    ...
    .hero.is-success.is-bold {
      background-image: linear-gradient(141deg, #ab989b 0%, <?php echo $colors["green"] ?> 71%, #cbc6c5 100%); }
      @media screen and (max-width: 768px) {
  ...
  .hero.is-warning {
    ...
    .hero.is-warning.is-bold {
      background-image: linear-gradient(141deg, #d9d0d2 0%, <?php echo $colors["yellow"] ?> 71%, #fbfbfb 100%); }
      @media screen and (max-width: 768px) {
  ...
  .hero.is-danger {
    ...
    .hero.is-danger.is-bold {
      background-image: linear-gradient(141deg, #9c8589 0%, <?php echo $colors["red"] ?> 71%, #bab4b3 100%); }
      @media screen and (max-width: 768px) {
  ...
  .hero.is-lightblue {
    ...
    .hero.is-lightblue.is-bold {
      background-image: linear-gradient(141deg, #8c7377 0%, <?php echo $colors["lightblue"] ?> 71%, #aaa3a1 100%); }
      @media screen and (max-width: 768px) {
  ...
  .hero.is-purple {
    ...
    .hero.is-purple.is-bold {
      background-image: linear-gradient(141deg, #e8e3e4 0%, <?php echo $colors["purple"] ?> 71%, white 100%); }
      @media screen and (max-width: 768px) {
  ...
  .hero.is-pink {
    ...
    .hero.is-pink.is-bold {
      background-image: linear-gradient(141deg, #675457 0%, <?php echo $colors["pink"] ?> 71%, #8a807e 100%); }
      @media screen and (max-width: 768px) {
  ...
  .hero.is-blue {
    ...
    .hero.is-blue.is-bold {
      background-image: linear-gradient(141deg, #c9bec0 0%, <?php echo $colors["blue"] ?> 71%, #ebe9e9 100%); }
      @media screen and (max-width: 768px) {
  ...
  .hero.is-orange {
    ...
    .hero.is-orange.is-bold {
      background-image: linear-gradient(141deg, #baabad 0%, <?php echo $colors["orange"] ?> 71%, #dbd7d7 100%); }
      @media screen and (max-width: 768px) {
