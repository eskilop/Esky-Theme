<?php
  ...
  function esky_generate_colorscheme() {
    ...
    *, *::before, *::after {
    ...
    strong {
      color: ' .  Color::toHexString(Color::lighten(Color::get($colors["white"]), 0.05)) . ' ;
      font-weight: 700; }
    ...
    a.has-text-dark:hover, a.has-text-dark:focus {
      color: ' .  Color::toHexString(Color::lighten(Color::get($colors["link"]), 0.05)) . '  !important; }
    ...
    a.has-text-info:hover, a.has-text-info:focus {
      color: ' .  Color::toHexString(Color::lighten(Color::get($colors["edark"]), 0.1)) . '  !important; }
    ...
    a.has-text-warning:hover, a.has-text-warning:focus {
      color: ' .  Color::toHexString(Color::lighten(Color::get($colors["edark"]), 0.5)) . '  !important; }
    ...
    .has-text-grey-light {
      color: ' .  Color::toHexString(Color::lighten(Color::get($colors["green"]), 0.05)) . '  !important; }
    
    .has-background-grey-light {
      background-color: ' .  Color::toHexString(Color::lighten(Color::get($colors["green"]), 0.05)) . '  !important; }
    ...
    a.box:hover, a.box:focus {
      box-shadow: 0 0.5em 1em -0.125em rgba(10, 10, 10, 0.1), 0 0 0 1px ' .  $colors["white"] . ' ; }
    a.box:active {
      box-shadow: inset 0 1px 2px rgba(10, 10, 10, 0.2), 0 0 0 1px ' .  $colors["white"] . ' ; }
    ...
    .button {
      ...
      .button.is-white {
        ...
        .button.is-white:hover, .button.is-white.is-hovered {
          background-color: ' .  Color::toHexString(Color::lighten(Color::get($colors["white"]), 0.05)) . ' ;
          border-color: transparent;
          color: #0a0a0a; }
      ...
      .button.is-light {
        ...
        .button.is-light:active, .button.is-light.is-active {
          background-color: ' .  Color::toHexString(Color::lighten(Color::get($colors["yellow"]), 0.05)) . ' ;
          border-color: transparent;
          color: rgba(0, 0, 0, 0.7); }
      ...
      .button.is-primary {
        ...
        .button.is-primary:hover, .button.is-primary.is-hovered {
          background-color: ' .  Color::toHexString(Color::lighten(Color::get($colors["primary"]), 0.05)) . ' ;
          border-color: transparent;
          color: #fff; }
      ...
      .button.is-link {
        ...
        .button.is-link:hover, .button.is-link.is-hovered {
          background-color: ' .  Color::toHexString(Color::lighten(Color::get($colors["link"]), 0.05)) . ' ;
          border-color: transparent;
          color: #fff; }
      ...
      .button.is-info {
        ...
        .button.is-info:hover, .button.is-info.is-hovered {
          background-color: ' .  Color::toHexString(Color::lighten(Color::get($colors["cyan"]), 0.05)) . ' ;
          border-color: transparent;
          color: #fff; }
        ...
        .button.is-info:active, .button.is-info.is-active {
          background-color: ' .  Color::toHexString(Color::lighten(Color::get($colors["edark"]), 0.15)) . ' ;
          border-color: transparent;
          color: #fff; }
      ...
      .button.is-success {
        ...
        .button.is-success:hover, .button.is-success.is-hovered {
          background-color: ' .  Color::toHexString(Color::lighten(Color::get($colors["green"]), 0.05)) . ' ;
          border-color: transparent;
          color: rgba(0, 0, 0, 0.7); }
      ...
      .button.is-danger {
        ...
        .button.is-danger:hover, .button.is-danger.is-hovered {
          background-color: ' .  Color::toHexString(Color::lighten(Color::get($colors["red"]), 0.05)) . ' ;
          border-color: transparent;
          color: #fff; }
      ...
      .button.is-lightblue {
        ...
        .button.is-lightblue:hover, .button.is-lightblue.is-hovered {
          background-color: ' .  Color::toHexString(Color::lighten(Color::get($colors["lightblue"]), 0.05)) . ' ;
          border-color: transparent;
          color: #fff; }
      ...
      .button.is-purple {
        ...
        .button.is-purple:hover, .button.is-purple.is-hovered {
          background-color: ' .  Color::toHexString(Color::lighten(Color::get($colors["purple"]), 0.05)) . ' ;
          border-color: transparent;
          color: rgba(0, 0, 0, 0.7); }
      ...
      .button.is-pink {
        ...
        .button.is-pink:hover, .button.is-pink.is-hovered {
          background-color: ' .  Color::toHexString(Color::lighten(Color::get($colors["pink"]), 0.05)) . ' ;
          border-color: transparent;
          color: #fff; }
      ...
      .button.is-blue {
        ...
        .button.is-blue:hover, .button.is-blue.is-hovered {
          background-color: ' .  Color::toHexString(Color::lighten(Color::get($colors["blue"]), 0.05)) . ' ;
          border-color: transparent;
          color: rgba(0, 0, 0, 0.7); }
      ...
      .button.is-orange {
        ...
        .button.is-orange:hover, .button.is-orange.is-hovered {
          background-color: ' .  Color::toHexString(Color::lighten(Color::get($colors["orange"]), 0.05)) . ' ;
          border-color: transparent;
          color: rgba(0, 0, 0, 0.7); }
    ...
    .select {
      ...
      .select.is-light select {
        ...
        .select.is-light select:hover, .select.is-light select.is-hovered {
          border-color: ' .  Color::toHexString(Color::lighten(Color::get($colors["yellow"]), 0.05)) . ' ; }
      ...
      .select.is-info select {
        ...
        .select.is-info select:hover, .select.is-info select.is-hovered {
          border-color: ' .  Color::toHexString(Color::lighten(Color::get($colors["edark"]), 0.15)) . ' ; }
    ...
    .file-label {
      ...
      .file-label:hover .file-cta {
        ...
        color: ' .  Color::toHexString(Color::lighten(Color::get($colors["edark"]), 0.5)) . ' ; }
      .file-label:hover .file-name {
        border-color: ' .  Color::toHexString(Color::lighten(Color::get($colors["edark"]), 0.5)) . ' ; }
    ...
    .breadcrumb {
      ...
      .breadcrumb li {
        ...
        .breadcrumb li + li::before {
          color: ' .  Color::toHexString(Color::lighten(Color::get($colors["green"]), 0.05)) . ' ;
          content: "/"; }
      .breadcrumb ul,
      .breadcrumb ol {
    ...
    .pagination-link {
      ...
      .pagination-link:hover {
        border-color: ' .  Color::toHexString(Color::lighten(Color::get($colors["green"]), 0.05)) . ' ;
        color: ' .  $colors["complementary"] . ' ; }
    ...
    .tabs {
      ...
      .tabs a {
        ...
        vertical-align: top; }
        .tabs a:hover {
          border-bottom-color: ' .  Color::toHexString(Color::lighten(Color::get($colors["white"]), 0.05)) . ' ;
          color: ' .  Color::toHexString(Color::lighten(Color::get($colors["white"]), 0.05)) . ' ; }
      .tabs li {
        display: block; }
        .tabs li.is-active a {
    ...
    .hero {
      ...
      .hero.is-white {
        ...
        .hero.is-white.is-bold {
          background-image: linear-gradient(141deg, #770014 0%, ' .  $colors["white"] . '  71%, #c42100 100%); }
          @media screen and (max-width: 768px) {
      ...
      .hero.is-primary {
        ...
        .hero.is-primary.is-bold {
          background-image: linear-gradient(141deg, #2f2628 0%, ' .  $colors["primary"] . '  71%, #554e4d 100%); }
          @media screen and (max-width: 768px) {
      ...
      .hero.is-link {
        ...
        .hero.is-link.is-bold {
          background-image: linear-gradient(141deg, #090808 0%, ' .  $colors["white"] . '  71%, #312d2c 100%); }
          @media screen and (max-width: 768px) {
      ...
      .hero.is-info {
        ...
        .hero.is-info.is-bold {
          background-image: linear-gradient(141deg, #7a6367 0%, ' .  $colors["cyan"] . '  71%, #9a918f 100%); }
          @media screen and (max-width: 768px) {
      ...
      .hero.is-success {
        ...
        .hero.is-success.is-bold {
          background-image: linear-gradient(141deg, #ab989b 0%, ' .  $colors["green"] . '  71%, #cbc6c5 100%); }
          @media screen and (max-width: 768px) {
      ...
      .hero.is-warning {
        ...
        .hero.is-warning.is-bold {
          background-image: linear-gradient(141deg, #d9d0d2 0%, ' .  $colors["yellow"] . '  71%, #fbfbfb 100%); }
          @media screen and (max-width: 768px) {
      ...
      .hero.is-danger {
        ...
        .hero.is-danger.is-bold {
          background-image: linear-gradient(141deg, #9c8589 0%, ' .  $colors["red"] . '  71%, #bab4b3 100%); }
          @media screen and (max-width: 768px) {
      ...
      .hero.is-lightblue {
        ...
        .hero.is-lightblue.is-bold {
          background-image: linear-gradient(141deg, #8c7377 0%, ' .  $colors["lightblue"] . '  71%, #aaa3a1 100%); }
          @media screen and (max-width: 768px) {
      ...
      .hero.is-purple {
        ...
        .hero.is-purple.is-bold {
          background-image: linear-gradient(141deg, #e8e3e4 0%, ' .  $colors["purple"] . '  71%, white 100%); }
          @media screen and (max-width: 768px) {
      ...
      .hero.is-pink {
        ...
        .hero.is-pink.is-bold {
          background-image: linear-gradient(141deg, #675457 0%, ' .  $colors["pink"] . '  71%, #8a807e 100%); }
          @media screen and (max-width: 768px) {
      ...
      .hero.is-blue {
        ...
        .hero.is-blue.is-bold {
          background-image: linear-gradient(141deg, #c9bec0 0%, ' .  $colors["blue"] . '  71%, #ebe9e9 100%); }
          @media screen and (max-width: 768px) {
      ...
      .hero.is-orange {
        ...
        .hero.is-orange.is-bold {
          background-image: linear-gradient(141deg, #baabad 0%, ' .  $colors["orange"] . '  71%, #dbd7d7 100%); }
          @media screen and (max-width: 768px) {
    ...
    a.read-btn:hover, a.read-btn:active, a.read-btn:focus {
      background-color: ' .  Color::toHexString(Color::lighten(Color::get($colors["edark"]), 0.15)) . '  !important;
    }
    .card-footer {
